...
class bdist_rpm(Command):
    ...
    user_options = [
        ...
        (
            'useful_things_for_front=',
            None,
            "RPM \"useful_things_for_front\" (eg. \"Joe Blow <joe@example.com>\") "
            "[default: maintainer or author from setup script]",
        ),
        (
            'packager=',
            None,
            "RPM packager (eg. \"Jane Doe <jane@example.net>\") " "[default: useful_things_for_front]",
        ),
    ...
    def run(self):
        if DEBUG:
            ...
            print("useful_things_for_front =", self.vendor)
